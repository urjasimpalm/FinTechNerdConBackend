...
//   POST user/guild/join           { "guild_id": 1 }
//   POST user/guild/leave          { "guild_id": 1 }
//
// Joining and leaving edit the same 1..3 selection that shows on the profile, so
// both go through public.set_user_guilds() — the join is refused at 3 guilds and
// the leave is refused at 1, because an attendee always belongs to at least one.
...
/** POST user/guild/join and .../leave */
